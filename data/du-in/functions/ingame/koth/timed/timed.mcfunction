...
execute as @a[gamemode=!spectator,tag=playing,tag=kothIngame] if score @s kothTimer > #main kothMost store result score #main kothMost run scoreboard players get @s kothTimer
