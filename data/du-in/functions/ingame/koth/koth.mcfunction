...
#END MAP EFFECTS#
execute if score #main map matches 2 run effect give @a[tag=!win,tag=!lose] minecraft:night_vision infinite 100 true
execute if score #main map matches 3 run effect give @a[tag=!win,tag=!lose] minecraft:night_vision infinite 100 true