execute if score #main kBluePoints = #main scoreMost run tag @a[tag=team2] add win
execute if score #main kRedPoints = #main scoreMost run tag @a[tag=team1] add win
