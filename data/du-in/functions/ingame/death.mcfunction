...
#If suicide
execute unless entity @s[scores={killedByPlayer=1..}] unless entity @s[scores={killedByCreeper=1..}] if entity @s[tag=cIngame,scores={killIngame=1..}] run function du-in:kit/all/kill/suicide
