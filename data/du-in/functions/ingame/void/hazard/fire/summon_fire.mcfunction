execute at @e[type=marker,tag=flamePillarX] run function du-in:ingame/void/hazard/fire/summon_fire_x
execute at @e[type=marker,tag=flamePillarZ] run function du-in:ingame/void/hazard/fire/summon_fire_z
...
schedule function du-in:ingame/void/hazard/fire/fire_end 5s