...
execute if score #main alarmCount matches 4 run function du-in:ingame/void/hazard/shock/electrocute

execute if score #main alarmCount matches ..3 as @a at @s run playsound minecraft:sus.emerg master @s ~ ~ ~ 10 .5
...
execute if score #main alarmCount matches ..3 run schedule function du-in:ingame/void/hazard/shock/alarm_start 22t
