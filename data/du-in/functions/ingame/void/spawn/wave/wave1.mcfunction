...
execute if score #main gonerCount matches ..5 if score #main pylonsDestroyed matches 1 as @e[type=marker,tag=gonerSpawn,predicate=du-in:chance/half_chance] at @s run function du-in:ingame/void/spawn/random2

execute if score #main gonerCount matches ..7 if score #main pylonsDestroyed matches 2 as @e[type=marker,tag=gonerSpawn,predicate=du-in:chance/half_chance] at @s run function du-in:ingame/void/spawn/random3
