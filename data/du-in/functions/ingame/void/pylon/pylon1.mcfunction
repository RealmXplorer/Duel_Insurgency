##Win and Lose conditions
    #Win condition
    execute if entity @a[tag=!win,scores={gonersKilled=..0},tag=partyLeader] run function du-in:ingame/void/end/win
    execute if entity @a[scores={gonersKilled=..0},tag=partyLeader] run function du-in:ingame/void/end/explode
