##Pylons
#Run if on Pylon 1
execute if score #main pylonsDestroyed matches 0 run function du-in:ingame/void/pylon/pylon1

#Run if on Pylon 2
execute if score #main pylonsDestroyed matches 1 run function du-in:ingame/void/pylon/pylon2

#Run if on Pylon 3
execute if score #main pylonsDestroyed matches 2 run function du-in:ingame/void/pylon/pylon3

#Run if on Pylon 4
execute if score #main pylonsDestroyed matches 3 run function du-in:ingame/void/pylon/pylon4
...
##Player Functions
    ...
    execute as @a[gamemode=!spectator,tag=void,tag=!win] at @s run function du-in:ingame/void/player_specific
