execute if entity @s[tag=!voidReady] run function du-in:ingame/void/interact/surrender
...
execute if entity @a[tag=devMode,tag=partyLeader] run function du-in:ingame/void/interact/begin_timer
execute if score #main voidReadyOnline = #main online run function du-in:ingame/void/interact/begin_timer