...
execute if entity @a[tag=devMode,tag=partyLeader] run item replace entity @a hotbar.4 with minecraft:barrier{display:{Name:'{"text":"End Game","color":"red","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}',Lore:['{"text":"Throw to activate!","color":"dark_purple","bold":true}']},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}],weaponItem:1b}