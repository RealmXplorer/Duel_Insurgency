...
execute if entity @s[scores={kit=4}] run playsound minecraft:entity.creeper.primed master @a ~ ~ ~ 1000 1
...
execute if entity @s[scores={kit=7}] run playsound minecraft:ui.toast.in master @a ~ ~ ~ 1 1

execute if entity @s[scores={kit=8}] unless entity @s[scores={villSkin=1..}] run playsound minecraft:entity.villager.ambient master @a ~ ~ ~ 1 1
execute if entity @s[scores={kit=8,villSkin=1}] run playsound minecraft:entity.vindicator.ambient master @a ~ ~ ~ 1 1
execute if entity @s[scores={kit=8,villSkin=2}] run playsound minecraft:entity.witch.ambient master @a ~ ~ ~ 1 1

execute if entity @s[scores={kit=1002},tag=kothIngame] run playsound minecraft:jerma.koth master @a ~ ~ ~ 1000 1
execute if entity @s[scores={kit=1001}] run playsound minecraft:paz.fnf.go master @s ~ ~ ~ 100000 1
