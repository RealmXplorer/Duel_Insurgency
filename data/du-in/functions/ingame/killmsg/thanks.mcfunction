#KILL MESSAGE#
execute unless entity @s[scores={kit=1000..}] run tellraw @a {"selector":"@s","color":"gold","bold":false,"extra":[{"text":" stuffed ","color":"white","bold":false},{"selector":"@a[scores={justdied=1}]","color":"yellow","bold":false}]}
...
execute if entity @s[scores={kit=1005}] run tellraw @a {"selector":"@s","color":"gold","bold":false,"extra":[{"text":" tackled ","color":"white","bold":false},{"selector":"@a[scores={justdied=1}]","color":"yellow","bold":false}]}
