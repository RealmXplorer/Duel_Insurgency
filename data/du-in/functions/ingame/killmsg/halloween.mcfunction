...
execute if entity @s[scores={kit=1005}] run tellraw @a {"selector":"@s","color":"dark_purple","bold":false,"extra":[{"text":" tackled ","color":"white","bold":false},{"selector":"@a[scores={justdied=1}]","color":"#fc8803","bold":false}]}
