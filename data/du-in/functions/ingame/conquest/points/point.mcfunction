...
execute if entity @s[scores={pointCap=..-101}] unless score Blue capturePoints matches 10000.. run scoreboard players add Blue capturePoints 1
execute if entity @s[scores={pointCap=101..}] unless score Red capturePoints matches 10000.. run scoreboard players add Red capturePoints 1
