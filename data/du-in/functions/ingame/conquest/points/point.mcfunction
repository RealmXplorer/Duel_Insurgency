#POINT 1#
    #RED CAP#
        execute if entity @a[gamemode=adventure,distance=..3,tag=!teamDead,scores={team=1}] run function du-in:ingame/conquest/points/red_color_check

    #BLUE CAP#
        execute if entity @a[gamemode=adventure,distance=..3,tag=!teamDead,scores={team=2}] run function du-in:ingame/conquest/points/blue_color_check
