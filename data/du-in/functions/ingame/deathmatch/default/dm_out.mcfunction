...
#execute if entity @s[tag=team1] run scoreboard players remove #main redTeamCount 1
#execute if entity @s[tag=team2] run scoreboard players remove #main blueTeamCount 1
