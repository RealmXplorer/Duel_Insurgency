...
execute if score #main cBluePoints > #main classicMost store result score #main classicMost run scoreboard players get #main cBluePoints
execute if score #main cRedPoints > #main classicMost store result score #main classicMost run scoreboard players get #main cRedPoints
