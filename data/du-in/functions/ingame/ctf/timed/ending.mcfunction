...
execute if score #main bluePoints = #main redPoints run tag @a add win
...
execute if score #main bluePoints < #main redPoints run tag @a[tag=ctfIngame,tag=team2] add lose
execute if score #main redPoints < #main bluePoints run tag @a[tag=ctfIngame,tag=team1] add lose
