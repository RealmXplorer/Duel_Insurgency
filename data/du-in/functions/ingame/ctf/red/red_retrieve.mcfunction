...
execute if entity @s[tag=!flagGot] run tellraw @a ["",{"selector":"@a[tag=team2,tag=flagGot]","bold":true,"color":"blue"},{"text":" has taken the ","color":"gray"},{"text":"Red ","bold":true,"color":"red"},{"text":"flag!","color":"gray"}]
...
#execute if entity @s[tag=flagGot] run scoreboard players set #main redFlagCooldown 20
