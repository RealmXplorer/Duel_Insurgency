...
# execute if entity @s[tag=!flagGot] run tellraw @a ["",{"selector":"@s","bold":true,"color":"dark_red"},{"text":" has retrieved the ","color":"gray"},{"text":"Blue ","bold":true,"color":"blue"},{"text":"flag!","color":"gray"}]
# execute if entity @s[tag=!flagGot] run playsound minecraft:entity.ender_dragon.growl master @a ~ ~ ~ 999999 1
# execute if entity @s[tag=!flagGot] run title @a title [{"text":"Blue ","bold":true,"color":"blue"},{"text":"flag retrieved!","color":"red"}]
