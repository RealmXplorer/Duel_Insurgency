...
#End
execute if score #main map matches 3 run playsound minecraft:ambient.wind ambient @s ~ ~ ~ 0.25 1 1
...
#Chancel
execute if score #main map matches 8 run playsound minecraft:ambient.wind ambient @s ~ ~ ~ 0.25 1 1
