    ...
    #Play Item
        ...
        execute unless items entity @s[gamemode=!creative,tag=!playing,tag=!working,tag=!subLobby,tag=!gamemodeSwitch] hotbar.4 minecraft:carrot_on_a_stick run function du-in:lobby/item/play
    ...
    #Gamemode Switch Item
        ...
        execute unless items entity @s[gamemode=!creative,tag=!playing,tag=!working,tag=!subLobby,tag=!gamemodeSwitch] hotbar.0 minecraft:carrot_on_a_stick run function du-in:lobby/item/switch
