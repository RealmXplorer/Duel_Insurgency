...
#Announce settings
execute if score #main cqCap matches 10000 run tellraw @a ["",{"text":"Conquest Points ","bold":true,"color":"gold"},{"text":"Max 10,000","color":"gray"},{"text":" (Default)","bold":true,"color":"green"}]
