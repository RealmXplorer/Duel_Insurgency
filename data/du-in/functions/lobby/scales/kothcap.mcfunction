...
execute as @a[tag=partyLeader,limit=1] if score @s kothScale matches 1 run scoreboard players set #main kothCap 2500
...
execute as @a[tag=partyLeader,limit=1] if score @s kothScale matches 4 run scoreboard players set #main kothCap 1000
...
execute if score #main kothCap matches 2500 run tellraw @a ["",{"text":"KOTH Points ","bold":true,"color":"red"},{"text":"Max 2500 (Extended)","color":"gray"}]
...
execute if score #main kothCap matches 1000 run tellraw @a ["",{"text":"KOTH Points ","bold":true,"color":"red"},{"text":"Max 1000 (Quick)","color":"gray"}]
