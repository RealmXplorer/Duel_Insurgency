...
execute if score #main lobbyTheme matches 1 run item replace entity @s[gamemode=!creative,tag=!playing,tag=!working,tag=!team2] hotbar.5 with minecraft:carrot_on_a_stick[custom_model_data=1039,custom_name='{"text":"Join Ghosts","color":"dark_purple","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'blueItem'}]
...
execute if score #main lobbyTheme matches 3 run item replace entity @s[gamemode=!creative,tag=!playing,tag=!working,tag=!team2] hotbar.5 with minecraft:carrot_on_a_stick[custom_model_data=1040,custom_name='{"text":"Join Elves","color":"dark_green","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'blueItem'}]
