execute if entity @s[scores={kitList=..0},tag=impostUnlocked] run function du-in:lobby/kitmenu/select/unlock/sus

#PURCHASE FUNCTIONS#
execute if entity @s[scores={kitList=..0},tag=!impostUnlocked] run scoreboard players enable @s buy
execute if entity @s[scores={kitList=..0},tag=!impostUnlocked] run trigger buy
execute if entity @s[scores={kitList=..0,buy=1..},tag=!impostUnlocked] run function du-in:kit/impostor/buy/buy
...
item replace entity @s[tag=kitMenu,tag=impostUnlocked] inventory.2 with minecraft:player_head{susHead:1b,display:{Name:'{"text":"The Impostor","color":"white","bold":true,"italic":false}',Lore:['{"text":"Among Us","color":"#C91048","bold":true,"italic":true}']},SkullOwner:{Id:[I;-662073347,1607614868,-1528156711,-1436011716],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTdkNWViMGFlYTVkNjFiYTNmZjQ5OTY0MTZhOTAwOTZhOWQ3NzYwOWViY2QzYjMwOGY5MDZhZTg4OGE0NWY2ZCJ9fX0="}]}},fixedItem:1b,weaponItem:1b,headItem:1b,lobbyItem:1b} 1
