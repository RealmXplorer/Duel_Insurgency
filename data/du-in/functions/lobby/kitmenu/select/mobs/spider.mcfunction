...
clear @s player_head{spiderHead:1b}
scoreboard players set @s kit 1
tellraw @s [{"text":"Selected the ","bold":true,"color":"gray"},{"text":"Spider ","bold":true,"color":"gold"},{"text":"class! ","bold":true,"color":"gray"},{"text":"(Click here for kit info!)","bold":false,"color":"white","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger info add 1"}}]
