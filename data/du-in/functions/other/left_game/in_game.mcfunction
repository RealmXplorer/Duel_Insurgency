...
execute if entity @a[tag=partyLeader,tag=!win,tag=!lose,tag=!winend] run tp @s[tag=spectating,tag=!working,tag=!dmDead] @r[tag=playing]
execute if entity @a[tag=partyLeader,tag=!win,tag=!lose,tag=!winend] run gamemode spectator @s[tag=spectating]
