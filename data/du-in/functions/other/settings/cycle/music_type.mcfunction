...
execute if entity @s[scores={musicCycle=6..}] run scoreboard players set @s musicCycle 0
...
execute if entity @s[scores={musicCycle=4}] run function du-in:other/settings/cycle/halloween_music
execute if entity @s[scores={musicCycle=5}] run function du-in:other/settings/cycle/christmas_music
