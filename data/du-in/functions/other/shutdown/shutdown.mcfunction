execute if score #main shutdown matches 1.. if score #main online matches 2.. if entity @a[tag=playing] run tellraw @a {"text":"Game shutdown canceled!","bold":true,"color":"green"}
