...
execute unless entity @s[scores={kit=10}] unless entity @s[scores={kit=12..14}] unless entity @s[scores={kit=16}] unless entity @s[scores={kit=20..22}] unless entity @s[scores={kit=25}] unless entity @s[scores={kit=1000..}] run function du-in:kit/all/win_music/start
#Win music
