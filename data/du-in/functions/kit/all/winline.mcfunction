...
execute if entity @s[scores={kit=26}] run playsound minecraft:jack_horner.win voice @a ~ ~ ~ 100 1
execute if entity @s[scores={kit=27}] run playsound minecraft:puss.win voice @a ~ ~ ~ 100 1
...
execute if entity @s[scores={kit=2015}] run playsound minecraft:saul.win voice @a ~ ~ ~ 100 1
