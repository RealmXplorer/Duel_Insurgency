...
execute unless entity @s[scores={kit=5}] unless entity @s[scores={kit=10}] unless entity @s[scores={kit=12..14}] unless entity @s[scores={kit=16}] unless entity @s[scores={kit=20..22}] unless entity @s[scores={kit=25..28}] unless entity @s[scores={kit=1000..}] run function du-in:kit/all/win_music/start

#Win music
execute if entity @s[scores={kit=10}] run playsound minecraft:gaster.pick record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=12}] run playsound minecraft:flowey.pick record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=13}] run playsound minecraft:papyrus.pick record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=14}] run playsound minecraft:asgore.pick record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=16}] run playsound minecraft:sans.pick record @a[tag=!musicOff] ~ ~ ~ 100 1 1

execute if entity @s[scores={kit=20}] run playsound minecraft:yharim.win record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=21}] run playsound minecraft:cuphead.knockout record @a ~ ~ ~ 100 1
execute if entity @s[scores={kit=22}] run playsound minecraft:gumball.win record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=25}] run playsound minecraft:clairen.victory record @a[tag=!musicOff] ~ ~ ~ 100 1


#Win Voicelines
execute if entity @s[scores={kit=5}] run playsound minecraft:springtrap.win voice @a[tag=!musicOff] ~ ~ ~ 100 1
...
execute if entity @s[scores={kit=1003}] run playsound minecraft:sus.victory record @a[tag=!musicOff] ~ ~ ~ 100 1
execute if entity @s[scores={kit=2015}] run playsound minecraft:saul.win voice @a[tag=!musicOff] ~ ~ ~ 100 1
