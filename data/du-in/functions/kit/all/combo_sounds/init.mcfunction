execute if entity @s[scores={comboScore=3},tag=playing] run function du-in:kit/all/combo_sounds/three
execute if entity @s[scores={comboScore=4},tag=playing] run function du-in:kit/all/combo_sounds/four
execute if entity @s[scores={comboScore=5},tag=playing] run function du-in:kit/all/combo_sounds/five
