...
execute if entity @e[type=skeleton,distance=.05..4] run function du-in:kit/ralsei/ability/void/success

#If player is too far
execute unless entity @e[type=skeleton,distance=.05..4] run function du-in:kit/all/ability/far
