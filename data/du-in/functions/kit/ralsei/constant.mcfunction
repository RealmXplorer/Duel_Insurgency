...
execute if entity @s[scores={ralseiTP=..119},tag=!stolen] if entity @a[distance=0.05..3,gamemode=!spectator] unless score @a[distance=0.05..3,tag=playing,gamemode=!spectator,limit=1] team = @s team run function du-in:kit/ralsei/tp/count
    #Max TP
