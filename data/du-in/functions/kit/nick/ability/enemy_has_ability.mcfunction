#Sabotage ability
execute if entity @s[scores={kit=1}] run function du-in:kit/nick/ability/sabotage/sabotage
execute if entity @s[scores={kit=3..7}] run function du-in:kit/nick/ability/sabotage/sabotage
execute if entity @s[scores={kit=11..20}] run function du-in:kit/nick/ability/sabotage/sabotage
