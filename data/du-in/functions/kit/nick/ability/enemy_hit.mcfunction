#Remove ability
execute unless entity @s[scores={kit=1}] unless entity @s[scores={kit=4..5}] unless entity @s[scores={kit=11}] unless entity @s[scores={kit=13}] unless entity @s[scores={kit=15}] unless entity @s[scores={kit=17}] unless entity @s[scores={kit=19..20}] unless entity @s[scores={kit=24}] unless entity @s[scores={kit=26}] unless entity @s[scores={kit=1000}] unless entity @s[scores={kit=1005}] run function du-in:kit/nick/ability/remove_ability
...
#Sabotage ability
execute if entity @s[scores={kit=1}] if entity @s[scores={kit=4..5}] if entity @s[scores={kit=11}] if entity @s[scores={kit=13}] if entity @s[scores={kit=15}] if entity @s[scores={kit=17}] if entity @s[scores={kit=19..20}] if entity @s[scores={kit=24}] if entity @s[scores={kit=26}] if entity @s[scores={kit=1000}] if entity @s[scores={kit=1005}] run function du-in:kit/nick/ability/sabotage
