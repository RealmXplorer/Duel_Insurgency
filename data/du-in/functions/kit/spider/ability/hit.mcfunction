effect give @a[distance=0.05..3,tag=playing,limit=1,sort=nearest,gamemode=!spectator,tag=!teamDead] minecraft:slowness 2 4 true
effect give @a[distance=0.05..3,tag=playing,limit=1,sort=nearest,gamemode=!spectator,tag=!teamDead] minecraft:mining_fatigue 2 0 true
...
tellraw @a[distance=0.05..3,tag=playing,gamemode=!spectator,tag=!dmDead,tag=!teamDead] [{"text":"You have been caught in a spider web!","bold":true,"color":"red"}]
