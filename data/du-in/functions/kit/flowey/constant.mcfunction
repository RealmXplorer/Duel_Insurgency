...
#WEAPON COUNT#
execute if entity @s[tag=!teamDead,tag=!stolen] unless entity @s[scores={floweyHitTimer=0..}] run function du-in:kit/flowey/weapon
...
#.105
attribute @s[tag=!stolen,tag=!pussFear,tag=!parry] generic.knockback_resistance base set 0.06
