...
execute if entity @s[scores={magicCount=2},tag=!magicBag,tag=!sabotaged] run function du-in:kit/jack_horner/ability/unicorn_bow/give
...
execute if entity @s[scores={magicCount=5},tag=!magicBag,tag=!sabotaged] run function du-in:kit/jack_horner/ability/ball/give
