...
execute unless score @s team = @a[distance=0.05..3,tag=playing,sort=nearest,limit=1] team run damage @a[distance=0.05..3,sort=nearest,limit=1,gamemode=!spectator] 2 arrow by @s
