...
#If projectile is parried
execute if entity @e[tag=projectile,distance=..4] unless entity @s[scores={parryTimer=1..}] if blocks ~ ~1 ~ ~ ~1 ~ ~ ~-.025 ~ all run function du-in:kit/cuphead/parry/success_project

#If player is parried
