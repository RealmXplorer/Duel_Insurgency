...
execute if entity @s[tag=!stolen,tag=!teamDead] unless entity @s[scores={secCount=1}] run item replace entity @s hotbar.0 with warped_fungus_on_a_stick{display:{Name:'{"text":"Devil\'s Horn","color":"#EF0AFF","bold":true}',Lore:['{"text":"Jump in the air and right click near enemy"}','{"text":"or projectile to parry!"}','{"text":"","color":"light_gray","bold":true}','{"text":"I didn\'t know this was a hat!","color":"white","bold":false}','{"text":"It wasn\'t...","color":"red","bold":false}']},Unbreakable:1b,CustomModelData:2014,weaponItem:1b,HideFlags:4,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:3.25,Operation:0,UUID:[I;1200076442,258100954,-1565177410,1292513131],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:40,Operation:0,UUID:[I;150931488,-224377682,-1476605358,-249302083],Slot:"mainhand"}]} 1
