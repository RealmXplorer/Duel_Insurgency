...
attribute @s[scores={Health=16..},tag=!stolen,tag=!skrunkMode] minecraft:generic.block_interaction_range base set 5
...
attribute @s[scores={Health=12..15},tag=!stolen,tag=!skrunkMode] minecraft:generic.block_interaction_range base set 4.5
...
attribute @s[scores={Health=8..11},tag=!stolen,tag=!skrunkMode] minecraft:generic.block_interaction_range base set 4.25
...
attribute @s[scores={Health=4..7},tag=!stolen,tag=!skrunkMode] minecraft:generic.block_interaction_range base set 4.15
...
attribute @s[scores={Health=..3},tag=!stolen,tag=!skrunkMode] minecraft:generic.block_interaction_range base set 4.15
