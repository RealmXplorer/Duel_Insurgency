...
effect give @s[scores={pussDeaths=1..},tag=!sabotaged] strength 2 0
effect give @s[scores={pussDeaths=2..},tag=!sabotaged] speed 2 1
effect give @s[scores={pussDeaths=3..},tag=!sabotaged] strength 3 0
effect give @s[scores={pussDeaths=5..},tag=!sabotaged] haste 3 0
effect give @s[scores={pussDeaths=6..},tag=!sabotaged] speed 3 1
