...
#Weapon
execute if entity @s[tag=!teamDead,tag=!stolen,tag=!pussFear] unless entity @s[scores={skeletonMode=1..}] unless entity @s[scores={weapCount=1}] run function du-in:kit/skeleton/weapon
