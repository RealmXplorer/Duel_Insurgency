...
execute as @e[type=block_display,tag=flame,tag=notSet] store result score @s team run scoreboard players get @a[scores={kit=14},tag=kitActions,sort=nearest,limit=1] team
