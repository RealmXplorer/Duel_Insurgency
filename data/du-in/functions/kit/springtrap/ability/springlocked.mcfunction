...
execute if entity @s[scores={Health=..9},predicate=du-in:low_chance,tag=!sabotaged] run tellraw @s {"text":"YOU WON'T DIE","color":"gray"}
execute if entity @s[scores={Health=..9},predicate=du-in:low_chance,tag=sabotaged] run tellraw @s {"text":"YOU'RE GONNA DIE'","color":"gray"}
