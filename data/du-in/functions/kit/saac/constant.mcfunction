...
execute if entity @s[scores={saacMoneyDollar=1}] run item replace entity @s hotbar.7 with minecraft:green_dye{display:{Name:'{"text":"Dollar","color":"#1AFF00","bold":true,"italic":false}',Lore:['{"text":"Dude thank you so much"}','{"text":"Im gonna use this "}','{"text":"at the vending machine"}','{"text":"lmao"}']},CustomModelData:100,du-in:weaponItem} 1
execute if entity @s[scores={saacMoneyDollar=2}] run item replace entity @s hotbar.7 with minecraft:green_dye{display:{Name:'{"text":"Dollar","color":"#1AFF00","bold":true,"italic":false}',Lore:['{"text":"Dude thank you so much"}','{"text":"Im gonna use this "}','{"text":"at the vending machine"}','{"text":"lmao"}']},du-in:weaponItem,CustomModelData:100} 2
execute if entity @s[scores={saacMoneyDollar=3}] run item replace entity @s hotbar.7 with minecraft:green_dye{display:{Name:'{"text":"Dollar","color":"#1AFF00","bold":true,"italic":false}',Lore:['{"text":"Dude thank you so much"}','{"text":"Im gonna use this "}','{"text":"at the vending machine"}','{"text":"lmao"}']},du-in:weaponItem,CustomModelData:100} 3
