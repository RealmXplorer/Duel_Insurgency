execute if entity @s[predicate=du-in:kickstart/kickstart1] run function du-in:kit/saac/kickstart/orange
execute if entity @s[predicate=du-in:kickstart/kickstart2] run function du-in:kit/saac/kickstart/yellow
