...
execute if entity @s[tag=!void] unless score @s team = @a[distance=0.05..3,tag=playing,limit=1,sort=nearest,tag=!teamDead,gamemode=!spectator] team run function du-in:kit/gumball/ability/darwin/start
...
execute if entity @s[tag=!void] if score @s team = @a[distance=0.05..3,tag=playing,limit=1,sort=nearest,gamemode=!spectator,tag=!teamDead] team run function du-in:kit/all/ability/team
