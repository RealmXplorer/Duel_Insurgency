...
execute if entity @s[scores={steveSkin=6}] run item replace entity @s hotbar.1 with minecraft:bow[custom_name='{"text":"Watergun","color":"gray","bold":true}',unbreakable={show_in_tooltip:false},custom_model_data=103] 1
