...
execute as @a[tag=song,tag=!musicOff,tag=!songEnd,tag=!oldPack,tag=!tournament,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.ffa record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=!musicOff,tag=!oldPack,tag=!tournament,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.ffaend record @s ~ ~ ~ 1000000 1 1
