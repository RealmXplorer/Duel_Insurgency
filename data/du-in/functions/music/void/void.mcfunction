...
execute unless score #main pylonsDestroyed matches 1.. run scoreboard players set @s[scores={ambience=2540..}] ambience 0
execute if entity @s[scores={ambience=1},tag=!musicOff] unless score #main pylonsDestroyed matches 1.. run playsound minecraft:music.suffocation master @s ~ ~ ~ 0.25 1 1
