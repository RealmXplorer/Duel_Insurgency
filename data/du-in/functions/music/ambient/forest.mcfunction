...
execute unless predicate du-in:ambience/night_check if entity @s[scores={ambience=1}] run playsound minecraft:soundeffect.forestamb ambient @s ~ ~ ~ 0.5 1 1
...
execute if predicate du-in:ambience/night_start run stopsound @s ambient minecraft:soundeffect.forestamb
