...
execute as @a[tag=free] at @s run playsound minecraft:music.free record @s ~ ~ ~ 1 1 1
execute as @a[tag=lobby,tag=credits] at @s run playsound minecraft:music.free record @s ~ ~ ~ 1 1 1
