...
#Vending Machines#
execute if entity @a[scores={kit=1000..1001}] run summon interaction 1999 11 -272 {Tags:["vending","mapSpecific"],width:1.15f,height:2.1f,response:1b}
execute if entity @a[scores={kit=1000..1001}] run summon interaction -2006 11 -262 {Tags:["vending","mapSpecific"],width:1.15f,height:2.1f,response:1b}
