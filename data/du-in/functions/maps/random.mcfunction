...
#execute if entity @s[tag=exl] store result score #main map run scoreboard players get @s exMapRandom
execute if entity @s[tag=quickMatch] run function du-in:maps/pick/init
