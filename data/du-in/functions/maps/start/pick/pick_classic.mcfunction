...
execute if score #main map matches 10 run function du-in:maps/start/classic/cliffside
...
execute if score #main map matches 13 run function du-in:maps/start/classic/saac_house
