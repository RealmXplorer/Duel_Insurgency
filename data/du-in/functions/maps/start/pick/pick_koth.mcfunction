execute if score #main map matches 1 run function du-in:maps/start/koth/ziggurat
execute if score #main map matches 2 run function du-in:maps/start/koth/nether
execute if score #main map matches 3 run function du-in:maps/start/koth/end
