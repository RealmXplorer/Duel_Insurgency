...
#Vending Machines#
execute if entity @a[scores={kit=1000..1001}] run summon interaction 50010 9 200017 {Tags:["vending","mapSpecific"],width:1.15f,height:2.1f,response:1b}
execute if entity @a[scores={kit=1000..1001}] run summon interaction 50036 8 200030 {Tags:["vending","mapSpecific"],width:1.15f,height:2.1f,response:1b}
