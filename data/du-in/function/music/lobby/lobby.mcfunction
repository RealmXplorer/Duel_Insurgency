execute if entity @s[tag=!beta,tag=!christmas,tag=!tournament,tag=!halloween,tag=!fromVoid,tag=!subLobby] run function du-in:music/lobby/default/lobby
...
#BETA#
execute if entity @s[tag=beta,tag=!tournament,tag=!christmas,tag=!fromVoid,tag=!subLobby] run function du-in:music/lobby/beta/lobby
