...
execute as @a[tag=song,tag=!songEnd,tag=tournament,tag=!musicOff,tag=!oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.tournamentffa record @s ~ ~ ~ 10000000000000000000000000 1 1
...
execute as @a[tag=songEnd,tag=tournament,tag=!musicOff,tag=!oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.tournamentffaend record @s ~ ~ ~ 10000000 1 1
