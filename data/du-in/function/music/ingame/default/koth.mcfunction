...
execute as @a[tag=song,tag=!songEnd,tag=!oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound du-in:music.koth record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=!oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul,tag=!musicOff] run playsound du-in:music.koth_end record @s ~ ~ ~ 1000000 1 1
