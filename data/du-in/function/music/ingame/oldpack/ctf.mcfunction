...
execute as @a[tag=song,tag=!songEnd,tag=oldPack,tag=!legacy,tag=!musicOff] at @s run playsound du-in:music.beta.ctf record @s ~ ~ ~ 10000000000000000000000000 1 1
...
execute as @a[tag=songEnd,tag=oldPack,tag=!legacy,tag=!musicOff] at @s run playsound du-in:music.beta.ctf_end record @s ~ ~ ~ 10000000 1 1
