...
execute as @a[tag=song,tag=!songEnd,tag=oldPack,tag=!legacy,tag=!musicOff] at @s run playsound du-in:music.beta.conquest record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=oldPack,tag=!legacy,tag=!musicOff] at @s run playsound du-in:music.beta.conquest_end record @s ~ ~ ~ 1000000 1 1
