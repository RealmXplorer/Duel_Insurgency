...
execute as @a[tag=song,tag=!songEnd,tag=oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound minecraft:oldmusic.koth record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=oldPack,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound minecraft:oldmusic.kothend record @s ~ ~ ~ 1000000 1 1
