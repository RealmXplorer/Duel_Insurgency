...
execute as @a[tag=song,tag=!songEnd,tag=oldPack,tag=!tournament,tag=!musicOff,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac, tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:oldmusic.ffa record @s ~ ~ ~ 10000000 1 1
...
execute as @a[tag=songEnd,tag=oldPack,tag=!tournament,tag=!musicOff,tag=!legacy,tag=!halloween,tag=!christmas,tag=!saac, tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:oldmusic.ffaend record @s ~ ~ ~ 10000000 1 1
