...
#tag=legacy,tag=!oldPack,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul,tag=!musicOff
execute as @a[tag=song,tag=!songEnd,tag=legacy,tag=!oldPack,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound minecraft:music.legacy.dm record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=legacy,tag=!oldPack,tag=!halloween,tag=!christmas,tag=!saac,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound minecraft:music.legacy.dmend record @s ~ ~ ~ 1000000 1 1
