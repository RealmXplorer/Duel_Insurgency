...
execute as @a[tag=song,tag=!songEnd,tag=legacy,tag=!oldPack,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound du-in:music.legacy.deathmatch record @s ~ ~ ~ 1000000 1 1
...
execute as @a[tag=songEnd,tag=legacy,tag=!oldPack,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul,tag=!musicOff] at @s run playsound du-in:music.legacy.deathmatch_end record @s ~ ~ ~ 1000000 1 1
