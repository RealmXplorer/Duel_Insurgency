...
execute as @a[tag=song,tag=!songEnd,tag=legacy,tag=!oldPack,tag=!tournament,tag=!musicOff,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.legacy.ffa record @s ~ ~ ~ 100000000000 1 1
...
execute as @a[tag=songEnd,tag=legacy,tag=!oldPack,tag=!tournament,tag=!musicOff,tag=!halloween,tag=!christmas,tag=!saac,tag=!jackBlack,tag=!bigChungus,tag=!saul] at @s run playsound minecraft:music.legacy.ffaend record @s ~ ~ ~ 10000000 1 1
