...
summon interaction -425.5 11.75 -34.5 {width:0.1,height:0.1,Tags:["kothObj","gameObject","mapSpecific"],CustomNameVisible:1b,CustomName:{text:"Stand on this point!",color:red,bold:true},UUID:[I;948641555,1070220056,-2113088080,1524825399]}

#Vending Machines#
execute if entity @a[tag=vendingMachine] positioned -441 14 -48 run function du-in:ingame/vending_machine/place/north
execute if entity @a[tag=vendingMachine] positioned -411 21 -51 run function du-in:ingame/vending_machine/place/east
execute if entity @a[tag=vendingMachine] positioned -417 22 -17 run function du-in:ingame/vending_machine/place/east
execute if entity @a[tag=vendingMachine] positioned -433 22 -23 run function du-in:ingame/vending_machine/place/west
