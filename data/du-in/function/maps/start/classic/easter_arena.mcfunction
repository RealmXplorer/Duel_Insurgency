...
execute if entity @a[tag=vendingMachine] positioned 931 10 507 run function du-in:ingame/vending_machine/place/north
execute if entity @a[tag=vendingMachine] positioned 948 10 490 run function du-in:ingame/vending_machine/place/west
execute if entity @a[tag=vendingMachine] positioned 931 10 473 run function du-in:ingame/vending_machine/place/south
execute if entity @a[tag=vendingMachine] positioned 914 10 490 run function du-in:ingame/vending_machine/place/east