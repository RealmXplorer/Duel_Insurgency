...
#Vending Machines#
execute if entity @a[tag=vendingMachine] positioned -2313 10 194 run function du-in:ingame/vending_machine/place/south
execute if entity @a[tag=vendingMachine] positioned -2325 8 194 run function du-in:ingame/vending_machine/place/west
execute if entity @a[tag=vendingMachine] positioned -2292 8 177 run function du-in:ingame/vending_machine/place/south
execute if entity @a[tag=vendingMachine] positioned -2290 10 205 run function du-in:ingame/vending_machine/place/east
execute if entity @a[tag=vendingMachine] positioned -2295 12 221 run function du-in:ingame/vending_machine/place/south
