...
#Vending Machines#
execute if entity @a[tag=vendingMachine] positioned 11 6 94 run function du-in:ingame/vending_machine/place/west
execute if entity @a[tag=vendingMachine] positioned 19 5 113 run function du-in:ingame/vending_machine/place/east
execute if entity @a[tag=vendingMachine] positioned -9 11 84 run function du-in:ingame/vending_machine/place/west
execute if entity @a[tag=vendingMachine] positioned 26 3 88 run function du-in:ingame/vending_machine/place/west
