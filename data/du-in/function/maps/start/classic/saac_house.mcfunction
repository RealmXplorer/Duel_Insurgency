...
execute if entity @a[tag=vendingMachine] positioned -2000 36 -1965 run function du-in:ingame/vending_machine/place/south
execute if entity @a[tag=vendingMachine] positioned -1996 39 -1976 run function du-in:ingame/vending_machine/place/north
execute if entity @a[tag=vendingMachine] positioned -2007 41 -1979 run function du-in:ingame/vending_machine/place/north
