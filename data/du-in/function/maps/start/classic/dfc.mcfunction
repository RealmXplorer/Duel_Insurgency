...
tp @a[tag=playing,scores={spawnpoint=0..2}] -2747 6 -5949 -180 0
tp @a[tag=playing,scores={spawnpoint=3..4}] -2726 6 -5970 90 0
tp @a[tag=playing,scores={spawnpoint=5..6}] -2747 6 -5991 0 0
tp @a[tag=playing,scores={spawnpoint=7..}] -2768 6 -5970 -90 0

tp @a[tag=audience,scores={spawnpoint=0..2}] -2747 6 -5949 -180 0
tp @a[tag=audience,scores={spawnpoint=3..4}] -2726 6 -5970 90 0
tp @a[tag=audience,scores={spawnpoint=5..6}] -2747 6 -5991 0 0
tp @a[tag=audience,scores={spawnpoint=7..}] -2768 6 -5970 -90 0
