...
execute if entity @a[tag=vendingMachine] positioned -4135 21 102 run function du-in:ingame/vending_machine/place/north
execute if entity @a[tag=vendingMachine] positioned -4137 21 109 run function du-in:ingame/vending_machine/place/west
execute if entity @a[tag=vendingMachine] positioned -4141 21 128 run function du-in:ingame/vending_machine/place/west
