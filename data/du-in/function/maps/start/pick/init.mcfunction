...
execute if entity @a[tag=cmap,tag=partyLeader,tag=!specialEvent] run function du-in:maps/start/pick/pick_classic
execute if entity @a[tag=cql,tag=partyLeader,tag=!specialEvent] run function du-in:maps/start/pick/pick_conquest
