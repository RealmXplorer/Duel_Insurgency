#Functionality
execute if entity @s[scores={skinList=..0}] run function du-in:kit/sauron/menu/skins/select

execute unless score #main pylonsDestroyed matches 3.. run item replace entity @s inventory.7 with minecraft:player_head[custom_data={du-in:'sauronHead'},custom_name={text:"Sauron Skins",color:white,bold:true,italic:false},lore=[{text:"None Available!",color:red,bold:true,"italic":true}],profile={properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTkxOWQxNTk0YmY4MDlkYjdiNDRiMzc4MmJmOTBhNjlmNDQ5YTg3Y2U1ZDE4Y2I0MGViNjUzZmRlYzI3MjIifX19"}]}] 1


# execute if entity @s[scores={skinList=..0},tag=sauronSkins] run function du-in:kit/sauron/menu/skins/select
# execute if entity @s[scores={skinList=..0},tag=!sauronSkins] run function du-in:kit/sauron/menu/skins/try

# #Void Head
execute if score #main pylonsDestroyed matches 3.. run item replace entity @s inventory.7 with minecraft:player_head[custom_data={du-in:'sauronHead'},custom_name={text:"I SEE YOU",color:gray,bold:true},lore=[{text:"Sauron",color:green,bold:true,"italic":true}],profile={id:[I;318736035,-1403303440,-1876061664,-609467480],name:"",properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTdlMGE5MGMyYjg0ODU1YzkwMDYzNmNmYzkyNWQ5ZjJkMDc4NjliMGNiZmE1MzhlMjYxMDcyMGI3ZDI0YWVlNSJ9fX0="}]}] 1
