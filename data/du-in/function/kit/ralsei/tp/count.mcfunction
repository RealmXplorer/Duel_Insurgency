...
execute if entity @s[scores={ralseiTP=70..}] run function du-in:kit/ralsei/secondary/tracker/item
execute if entity @s[scores={ralseiTP=100..}] run function du-in:kit/ralsei/secondary/tracker/item
execute if entity @s[scores={ralseiTP=130..}] run function du-in:kit/ralsei/secondary/tracker/item
