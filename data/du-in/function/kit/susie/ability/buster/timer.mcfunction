...
execute if entity @s[scores={susieTimer=..0}] as @n[type=item_display,tag=susieAbility] if score @s player = @n[type=armor_stand,tag=susieAbility] player run function du-in:kit/susie/ability/buster/kill
