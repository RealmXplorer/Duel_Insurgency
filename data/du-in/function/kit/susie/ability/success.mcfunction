...
execute if entity @s[tag=!redBuster] run playsound du-in:kit.susie.rude_buster.shoot master @a ~ ~ ~ 10 1
execute if entity @s[tag=redBuster] run playsound du-in:kit.susie.rude_buster.shoot master @a ~ ~ ~ 10 0.75
