...
# execute if entity @s[scores={step=150..}] run function du-in:kit/susie/events/step
# execute if entity @s[scores={sprint=150..}] run function du-in:kit/susie/events/step
...
#TP Meter Item
# execute unless entity @s[scores={triCount=1}] if entity @s[tag=!teamDead] run function du-in:kit/susie/secondary/tracker/item
...
#execute if entity @s[tag=secKitActions] run function du-in:kit/susie/secondary/init
