...
#execute if entity @s[scores={pussWeapSwitch=1}] unless entity @s[scores={pussSkin=1}] run playsound du-in:kit.puss.gatito voice @a
#execute if entity @s[scores={pussSkin=1,pussWeapSwitch=1}] run playsound du-in:kit.kitty.gatito voice @a
