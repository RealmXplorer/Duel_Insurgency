...
execute as @a[gamemode=adventure,distance=0.05..5] unless score @s team = @p[scores={kit=11},tag=asrielCharge] team run damage @s 6 by @p[scores={kit=11},tag=asrielCharge]
...
execute if entity @s[tag=void] as @e[type=skeleton,distance=0.05..5] run damage @s 10 by @p[scores={kit=11},tag=asrielCharge]
