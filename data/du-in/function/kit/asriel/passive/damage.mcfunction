...
execute as @a[gamemode=adventure,distance=0.05..5] unless score @s team = @p[scores={kit=11},tag=asrielCharge,distance=..5] team run damage @s 6 magic by @p[scores={kit=11},tag=asrielCharge,distance=..5]
...
execute if entity @s[tag=void] as @e[type=skeleton,distance=0.05..5] run damage @s 10 magic by @p[scores={kit=11},tag=asrielCharge,distance=..5]
