...
#TP Meter Item
#execute unless entity @s[scores={triCount=1}] if entity @s[tag=!teamDead] run function du-in:kit/judy/secondary/tracker/item
...
#execute if entity @s[tag=secKitActions] run function du-in:kit/judy/secondary/init
