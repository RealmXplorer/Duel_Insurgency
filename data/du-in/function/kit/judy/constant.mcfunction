#Heal Prayer#
execute unless entity @s[scores={secCount=1}] run item replace entity @s[tag=!teamDead] hotbar.1 with minecraft:warped_fungus_on_a_stick[item_name={text:"Inspiration",color:"gold",bold:true},lore=[{text:"Right click to use!",color:green,bold:true}],item_model="du-in:abilities/badge",unbreakable={}] 1
...
#TP Counting and Max
execute if entity @s[tag=!startgame,tag=!inspireFull,scores={judyInspire=..120}] run function du-in:kit/judy/inspire_track
