...
execute as @a[gamemode=adventure,distance=..1.5] unless score @s team = @n[type=salmon,tag=kratosRock] team unless score @s player = @n[type=salmon,tag=kratosRock] player run function du-in:kit/kratos/ability/rock/damage
