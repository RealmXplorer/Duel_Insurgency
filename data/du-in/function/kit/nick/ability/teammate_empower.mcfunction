...
#Slime
execute if entity @s[scores={kit=3}] run function du-in:kit/nick/ability/empower
#Asriel
...
#Susie
execute if entity @s[scores={kit=36}] run function du-in:kit/nick/ability/empower
#Jevil
