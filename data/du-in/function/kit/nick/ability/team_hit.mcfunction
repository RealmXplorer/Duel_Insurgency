execute if entity @s[tag=!wilde] run function du-in:kit/nick/ability/empower
...
execute if entity @s[predicate=du-in:effect/has_weakness] run effect give @s strength 2 0 true
execute if entity @s[predicate=du-in:effect/has_weakness] run effect clear @s weakness

execute if entity @s[predicate=du-in:effect/has_slowness] run effect give @s speed 4 2 true
