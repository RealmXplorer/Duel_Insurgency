...
execute if entity @s[scores={kit=24..29}] run function du-in:kit/nick/ability/sabotage/no_ability
...
execute if entity @s[scores={kit=1004}] run function du-in:kit/nick/ability/sabotage/no_ability
