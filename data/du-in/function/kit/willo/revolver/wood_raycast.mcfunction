...
particle dust_color_transition{from_color:[0.510,0.478,0.408],to_color:[0.141,0.141,0.137],scale:1} ~ ~ ~ 0 0 0 0 5 normal
...
execute if entity @s[tag=hitWood] run tag @s add woodStop
...
#Continue path
execute positioned ^ ^ ^1 if entity @s[tag=!hitStone,tag=!hitDirt,tag=!hitWood,distance=..30] run function du-in:kit/willo/revolver/wood_raycast
