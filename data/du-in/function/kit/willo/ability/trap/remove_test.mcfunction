...
$execute at @n[distance=..10,tag=willoRemove,scores={player=$(current)},type=interaction] as @n[distance=..1,tag=willoTrap,type=marker] run return run function du-in:kit/willo/ability/trap/clear with storage du-in:willo_trap player
