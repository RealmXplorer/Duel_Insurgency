...
$execute at @n[distance=..10,tag=willoRemove,scores={player=$(current)},type=interaction] as @n[distance=..1,tag=willoTrap,type=marker] run function du-in:kit/willo/ability/trap/reset_start
