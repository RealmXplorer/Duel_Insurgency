...
attribute @s attack_damage base set 0.85
attribute @s minecraft:movement_efficiency base set 0.15
...
#New Attributes
attribute @s minecraft:air_drag_modifier base set 0.90
attribute @s minecraft:friction_modifier base set 1.1