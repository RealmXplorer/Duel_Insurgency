execute unless items entity @s[predicate=!du-in:runza_hold,tag=!flagGot,tag=!airBlock,tag=!groundBlock,tag=!inTheModel] weapon.mainhand #du-in:secondary run function du-in:kit/all/ability/activate
