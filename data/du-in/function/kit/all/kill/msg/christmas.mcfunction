...
execute if entity @s[scores={kit=1002}] run tellraw @a {selector:"@s",color:red,bold:false,extra:[{text:" zerked ",color:white,bold:false},{selector:"@a[scores={justdied=1}]",color:green,bold:false}]}
execute if entity @s[scores={kit=1003}] run tellraw @a {selector:"@s",color:red,bold:false,extra:[{text:" ejected ",color:white,bold:false},{selector:"@a[scores={justdied=1}]",color:green,bold:false}]}
