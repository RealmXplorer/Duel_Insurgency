...
execute if entity @s[scores={gumballPursueTimer=15}] run playsound du-in:sfx.ut.battlestart master @a ~ ~ ~ 1 1.25
...
execute if entity @s[tag=void,scores={gumballPursueTimer=15..}] if entity @e[distance=0.05..2,type=skeleton,tag=gonerThing] run function du-in:kit/gumball/ability/gumball/explode
