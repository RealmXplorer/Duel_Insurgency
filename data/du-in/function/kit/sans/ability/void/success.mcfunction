...
execute if entity @s[tag=stolen] unless entity @s[scores={villSkin=1..}] run item replace entity @s armor.head with minecraft:player_head[custom_name='{"text":"Villager Glowing Eye"}',profile={id:[I;-1609821516,1001276308,-1990293118,2111808159],name:"",properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTdhZjAxMjA5ZmJmMGFiNjE3MDdjN2NkN2NmMjVlOGNkMWYzYTJjNmJkNTM1M2NkYjQwZmFlZTI5NjM0NDVjNiJ9fX0="}]}] 1
execute if entity @s[tag=stolen] run item replace entity @s[scores={villSkin=1}] armor.head with minecraft:player_head[custom_name='{"text":"Vindicator Glowing Eye"}',profile={id:[I;460001161,315772245,-1326845913,-282502319],name:"",properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTEwYTQyZTIzNGY3NTBmZjdkNjM5OTg4NzEwZWZjZDU5ZWY3NjEwM2Y1ZTY0YzA5OTAzMjc0MGFjNzZkODAzNSJ9fX0="}]}] 1
execute if entity @s[tag=stolen] run item replace entity @s[scores={villSkin=2}] armor.head with minecraft:player_head[custom_name='{"text":"Witch Glowing Eye"}',profile={id:[I;-156087514,268190548,-2014839634,1772345224],name:"",properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZWY4NjA5ZDkzMzcyNGU5NDlkZDkxZjdiNzA5NzFhYjNiNGZmMDM5MmM0Njc1N2Y2ZDg5NjNmZjZjZTBkMjBmYyJ9fX0="}]}] 1
