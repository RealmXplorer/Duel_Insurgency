tp @s ~ ~ ~ facing entity @n[type=skeleton,tag=gonerThing,tag=sansHit,distance=..5] feet

scoreboard players set @e[type=skeleton,tag=sansHit,distance=..5] sansHitTimer 60
tag @e[type=skeleton,tag=sansHit,distance=..5] add sansHitDuration
