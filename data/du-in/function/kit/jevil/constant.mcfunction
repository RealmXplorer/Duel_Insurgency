...
#TP Meter Item
#execute unless entity @s[scores={triCount=1}] if entity @s[tag=!teamDead] run function du-in:kit/jevil/secondary/tracker/item
...
#execute if entity @s[tag=secKitActions] run function du-in:kit/jevil/secondary/init
