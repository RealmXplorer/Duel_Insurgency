#Summon beam
summon block_display ~ ~0.5 ~ {height:30f,Tags:["devilsKnife","unsetTime","projectile","mapSpecific"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,30f,1f]},block_state:{id:"minecraft:stripped_pale_oak_log"}}
