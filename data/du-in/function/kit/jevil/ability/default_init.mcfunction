...
execute if entity @s[tag=!neoChaos] if entity @a[distance=.05..4,tag=playing,gamemode=!spectator,tag=!teamDead,gamemode=!spectator] run function du-in:kit/jevil/ability/success
