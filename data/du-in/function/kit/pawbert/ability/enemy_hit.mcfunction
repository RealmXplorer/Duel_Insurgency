...
execute if items entity @s inventory.* #du-in:ability run function du-in:kit/pawbert/ability/sabotage/sabotage_enemy
execute unless items entity @s inventory.* #du-in:ability run function du-in:kit/pawbert/ability/sabotage/enemy_no_ability
...
clear @s[tag=stolen] #du-in:ability
tellraw @s[tag=!sabotaged] [{text:"You've been backstabbed!",bold:true,color:red}]
