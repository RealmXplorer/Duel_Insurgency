...
execute unless entity @s[tag=sabotaged] as @a[gamemode=!spectator,tag=!hacker] at @s run summon ender_pearl ~ ~ ~ {NoGravity:1b,Owner:[I;0,0,0,0],Tags:["blakeTP","notAssigned"],Item:{id:"minecraft:ender_pearl",count:1,components:{"minecraft:item_model":"du-in:item/abilities/disconnect"}}}
...
execute if entity @s[tag=sabotaged] run summon ender_pearl ~ ~ ~ {NoGravity:1b,Owner:[I;0,0,0,0],Tags:["blakeTP","notAssigned"],Item:{id:"minecraft:ender_pearl",count:1,components:{"minecraft:item_model":"du-in:item/abilities/disconnect"}}}
