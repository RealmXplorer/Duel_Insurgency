...
execute if entity @s[tag=!empower] as @a[gamemode=!spectator,tag=playing,distance=..1.25,tag=!phoenixShoot] at @s run function du-in:kit/jack_horner/ability/phoenix/hit
execute if entity @s[tag=empower] as @a[gamemode=!spectator,tag=playing,distance=..1.25,tag=!phoenixShoot] at @s run function du-in:kit/jack_horner/ability/phoenix/empowered_hit
