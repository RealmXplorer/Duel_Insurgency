...
execute if entity @s[tag=empower] run item replace entity @s hotbar.0 with minecraft:stone_axe[item_name={text:"The HATCHET!",color:gold,bold:true},lore=[{text:"Don't get hit with it!",color:dark_purple,bold:true}],max_damage=2,attribute_modifiers=[{type:"attack_damage",id:"attack_damage",amount:15,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"attack_speed",amount:-2.5,operation:"add_value",slot:"mainhand"}]] 1
