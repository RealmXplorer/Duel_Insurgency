...
execute if entity @s[tag=!magicBag,scores={magicCount=4},tag=!sabotaged] run function du-in:kit/jack_horner/ability/unicorn_bow/give
execute if entity @s[tag=!magicBag,scores={magicCount=5},tag=!sabotaged] run function du-in:kit/jack_horner/ability/phoenix/give
execute if entity @s[tag=!magicBag,scores={magicCount=6},tag=!sabotaged] run function du-in:kit/jack_horner/ability/hatchet/give
#execute if entity @s[tag=!magicBag,scores={magicCount=7},tag=!sabotaged] run function du-in:kit/jack_horner/ability/ball/give
