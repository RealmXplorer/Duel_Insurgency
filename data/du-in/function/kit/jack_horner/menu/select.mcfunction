...
#Play sound
playsound du-in:kit.jack_horner.bumbum record @s ~ ~ ~ 1 1

#Announce kit pick
tellraw @s [{text:"Selected the ",bold:true,color:gray},{text:"Big Jack Horner ",bold:true,color:gold},{text:"class! ",bold:true,color:gray},{text:"(Click here for kit info!)",bold:false,color:white,"underlined":true,"click_event":{"action":"run_command","command":"/trigger info add 1"}}]
