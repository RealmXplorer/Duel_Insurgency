...
execute if entity @s[scores={saacMoneyCheck=0}] run item replace entity @s hotbar.5 with air
execute if entity @s[scores={saacMoneyDollar=0}] run item replace entity @s hotbar.6 with air
