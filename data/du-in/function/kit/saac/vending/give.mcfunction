...
execute if entity @s[scores={kickstartKind=1}] run give @s minecraft:cocoa_beans[item_name={text:"Orange Kickstart",bold:true,color:"#FF8800"},lore=[{text:"I need it... I NEED IT!",bold:true}],item_model="du-in:other/kickstart2",consumable={consume_seconds:0,animation:"drink",sound:"entity.generic.drink",has_consume_particles:false},max_stack_size=1]
execute if entity @s[scores={kickstartKind=2}] run give @s minecraft:cocoa_beans[item_name={text:"Pineapple Kickstart",bold:true,color:yellow},lore=[{text:"I need it... I NEED IT!",bold:true}],item_model="du-in:other/kickstart1",consumable={consume_seconds:0,animation:"drink",sound:"entity.generic.drink",has_consume_particles:false},max_stack_size=1]
execute if entity @s[scores={kickstartKind=3}] run give @s minecraft:cocoa_beans[item_name={text:"Fruit Punch Kickstart",bold:true,color:red},lore=[{text:"I need it... I NEED IT!",bold:true}],item_model="du-in:other/kickstart3",consumable={consume_seconds:0,animation:"drink",sound:"entity.generic.drink",has_consume_particles:false},max_stack_size=1]
execute if entity @s[scores={kickstartKind=4}] run give @s minecraft:cocoa_beans[item_name={text:"Blueberry Kickstart",bold:true,color:blue},lore=[{text:"I need it... I NEED IT!",bold:true}],item_model="du-in:other/kickstart4",consumable={consume_seconds:0,animation:"drink",sound:"entity.generic.drink",has_consume_particles:false},max_stack_size=1]
