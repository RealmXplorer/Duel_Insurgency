...
execute if entity @s[scores={kickstartKind=2}] run give @s minecraft:warped_fungus_on_a_stick[custom_name='{"text":"Pineapple Kickstart","bold":true,"color":"yellow","italic":false}',lore=['{"text":"I need it... I NEED IT!","bold":true}'],item_model="du-in:other/kickstart"]
