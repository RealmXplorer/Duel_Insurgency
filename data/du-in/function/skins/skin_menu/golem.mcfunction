#Functionality
execute if entity @s[scores={skinList=..0},tag=golemSkins] run function du-in:skins/golem
execute if entity @s[scores={skinList=..0},tag=!golemSkins] run function du-in:skins/skin_menu/buy/golem/try
