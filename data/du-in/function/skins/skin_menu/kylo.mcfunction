#Functionality
execute if entity @s[scores={skinList=..0},tag=kyloSkins] run function du-in:skins/kylo
execute if entity @s[scores={skinList=..0},tag=!kyloSkins] run function du-in:skins/skin_menu/buy/kylo/try
