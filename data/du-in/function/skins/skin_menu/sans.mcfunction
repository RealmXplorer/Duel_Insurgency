#Functionality
execute if entity @s[scores={skinList=..0},tag=sansSkins] run function du-in:skins/sans
execute if entity @s[scores={skinList=..0},tag=!sansSkins] run function du-in:skins/skin_menu/buy/sans/try
