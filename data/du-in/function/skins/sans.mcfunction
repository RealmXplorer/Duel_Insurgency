...
# scoreboard players reset @s[scores={sansSkin=3..}] sansSkin
...
tellraw @s[tag=!defaultSelect,scores={sansSkin=2}] ["",{text:"Jevil ",bold:true,color:dark_purple},{text:"skin selected!",color:yellow}]