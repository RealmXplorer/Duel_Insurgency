...
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1440}] subtitle {text:"I SEE",bold:false,color:gray}
...
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1580}] subtitle {text:"YOUR CURIOSITY",bold:false,color:gray}
...
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1720}] subtitle {text:"MY EXPERIMENT",bold:false,color:gray}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1720}] times 60 20 60

title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1860}] title {text:"",bold:true,color:gold}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1860}] subtitle {text:"HOW INTERESTING",bold:false,color:gray}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=1860}] times 60 20 60

title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2000}] title {text:"",bold:true,color:gold}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2000}] subtitle {text:"VERY WELL",bold:false,color:gray}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2000}] times 60 20 60

title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2140}] title {text:"",bold:true,color:gold}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2140}] subtitle {text:"THE EXPERIMENTS WILL CONTINUE",bold:false,color:gray}
title @s[tag=lobby,tag=beatenGame,scores={creditsTimer=2140}] times 60 20 60
