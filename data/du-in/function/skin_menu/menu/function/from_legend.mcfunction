...
item replace entity @s[scores={skinTheme=0}] inventory.23 with minecraft:carrot_on_a_stick[item_model="du-in:lobby/back",item_name={text:"Normal Kits",color:blue,bold:true}]
