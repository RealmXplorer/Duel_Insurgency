...
#Add KOTH points
execute unless entity @a[gamemode=!spectator,tag=playing,distance=..2,tag=!gasterInvisible,tag=!floweyDuration,tag=!win,tag=!lose,tag=team2] as @a[gamemode=!spectator,tag=playing,distance=..2,tag=!gasterInvisible,tag=!floweyDuration,tag=!win,tag=!lose,tag=team1] unless score #main onPoint matches 2.. run scoreboard players add @s kothTimer 1
execute unless entity @a[gamemode=!spectator,tag=playing,distance=..2,tag=!gasterInvisible,tag=!floweyDuration,tag=!win,tag=!lose,tag=team1] as @a[gamemode=!spectator,tag=playing,distance=..2,tag=!gasterInvisible,tag=!floweyDuration,tag=!win,tag=!lose,tag=team2] unless score #main onPoint matches 2.. run scoreboard players add @s kothTimer 1
