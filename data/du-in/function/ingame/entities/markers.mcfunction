...
#Papyrus Marker
execute if entity @s[scores={papyrusHitTimer=-1..},tag=papyrusFind] run return run function du-in:kit/papyrus/ability/bones/timer
...
execute if entity @s[tag=poisonApple] run return run kill @s[tag=poisonApple]

#Impostor Meeting Spot
execute if entity @s[tag=meetingSpot,scores={impostTimer=0..}] run return run function du-in:kit/impostor/ability/meeting_spot

#Clairen Field
execute if entity @s[tag=clairenField] run return run function du-in:kit/clairen/ability/field
