...
#Cave Update
execute if score #main map matches 4 run playsound du-in:ambient.cave ambient @s ~ ~ ~ 0.25 1 1

#Mustafar has ambience in biome

#Ebbot
execute if score #main map matches 6 run function du-in:ingame/scheduled/ambience/forest

#Arena needs no ambience

#Dust 2
execute if score #main map matches 8 run function du-in:ingame/scheduled/ambience/desert

#Maze
execute if score #main map matches 9 run function du-in:ingame/scheduled/ambience/forest

#Cliffside
#execute if score #main map matches 10 run playsound du-in:ambient.wind ambient @s ~ ~ ~ 2 1 1
...
#Wishing Star
execute if score #main map matches 12 run playsound du-in:ambient.wind ambient @s ~ ~ ~ 0.25 1 1

#Saac House
#execute if score #main map matches 13 run function du-in:ingame/scheduled/ambience/forest

#Haunted House
#execute if score #main map matches 14 run playsound du-in:ambient.wind ambient @s ~ ~ ~ 0.25 1 1
