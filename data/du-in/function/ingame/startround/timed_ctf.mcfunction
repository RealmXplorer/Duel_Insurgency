...
#execute if score #main map matches 1 at @r run playsound du-in:sfx.ut.judge master @a ~ ~ ~ 10000 1 1
...
function du-in:ingame/ctf/timed/set_timers with storage du-in:gamemode timer
