...
execute if entity @s[scores={Health=..19}] unless entity @s[scores={kit=16}] unless entity @s[scores={kit=24}] unless entity @s[scores={kit=27}] run playsound minecraft:chara.ability master @a ~ ~ ~ 0.5 1.7
