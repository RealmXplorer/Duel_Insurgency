...
#Jukebox
execute unless entity @a[tag=shop] run summon interaction 1977 52 1987 {Tags:["jukeBox","tabba","mapSpecific"],width:1.05f,height:1.25f,response:1b,CustomNameVisible:1b,CustomName:{text:"Music",color:"green",bold:true}}

#Drink Bar
execute unless entity @a[tag=shop] run summon interaction 1970 53 1986 {Tags:["drinkShop","tabba","mapSpecific"],width:1.05f,height:0.75f,response:1b,CustomNameVisible:1b,CustomName:{text:"Drinks (-5 Diamonds)",color:"aqua",bold:true}}
