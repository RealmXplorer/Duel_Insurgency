...
execute unless score #main pylonsDestroyed matches 3 unless entity @a[scores={mapVote=4}] unless block ~ ~-1 ~ minecraft:red_concrete run setblock ~ ~-1 ~ minecraft:red_concrete destroy
execute if score #main pylonsDestroyed matches 3 unless entity @a[scores={mapVote=4}] unless block ~ ~-1 ~ minecraft:gray_concrete run setblock ~ ~-1 ~ minecraft:gray_concrete destroy
