...
execute if entity @a[tag=partyLeader,tag=specialEvent] run tellraw @a [{selector:"@s",bold:true},{text:" has picked the ",bold:true,color:gray},{text:"Iron Golem ",bold:true,color:gold},{text:"class! ",bold:true,color:gray}]
