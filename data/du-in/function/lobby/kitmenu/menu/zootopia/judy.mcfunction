...
#xecute if entity @s[tag=!kitsListed] run function du-in:lobby/kitmenu/select/zootopia/judy with storage du-in:main player
...
#xecute if entity @s[scores={kitList=1..}] run scoreboard players remove @s kitList 1