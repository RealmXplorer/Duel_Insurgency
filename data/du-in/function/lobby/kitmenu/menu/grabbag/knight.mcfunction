...
item replace entity @s[tag=kitMenu] inventory.11 with minecraft:player_head[custom_data={du-in:'knightHead'},custom_name={text:"The Knight",color:white,bold:true,italic:false},lore=[{text:"Hollow Knight",color:"#43a9e0",bold:true,"italic":true}],profile={id:[I;-2064725094,746081764,-1197498328,1118261278],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzNmOGEwODk5YmNiZjI5Mzk4YTIzMWU0MDYwYTExZmI1ZWRkYzkxMmZiNmQ1MTcyZDY2ODBmNDE0MzcwYWQyMCJ9fX0="}]}]
