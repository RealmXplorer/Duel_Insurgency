...
#Display Kits
#execute unless items entity @s inventory.11 minecraft:player_head run function du-in:lobby/kitmenu/menu/grabbag/cinder
...
execute unless items entity @s inventory.4 minecraft:player_head run function du-in:lobby/kitmenu/menu/grabbag/cinder
