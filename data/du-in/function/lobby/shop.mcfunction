...
#Skin menu
execute if entity @s[tag=skinMenu,gamemode=adventure] run function du-in:skin_menu/menu/common
...
# Shop Actions #
    execute if entity @s[scores={kitUse=1..}] run function du-in:lobby/shop/kit_use
