...
execute if score Realm_Xplorer redOnline <= Realm_Xplorer blueOnline as @r[tag=!team1,tag=!team2,sort=nearest] run function du-in:lobby/team_select/actions/pick_red
