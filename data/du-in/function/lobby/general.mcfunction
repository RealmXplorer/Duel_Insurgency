...
execute if score #main lobby matches 2 run scoreboard players set #main kitOnline 0
...
execute if score #main lobby matches 2 run function du-in:lobby/map_select/general