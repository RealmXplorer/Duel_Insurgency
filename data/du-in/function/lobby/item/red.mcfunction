...
execute if score #main lobbyTheme matches 1 run item replace entity @s[tag=!team1] hotbar.3 with minecraft:carrot_on_a_stick[custom_model_data=1038,custom_name='{"text":"Join Ghouls","color":"gold","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'redItem'}]
execute if score #main lobbyTheme matches 1 run item replace entity @s[tag=team1] hotbar.3 with minecraft:carrot_on_a_stick[custom_model_data=1038,custom_name='{"text":"Join Ghouls","color":"gold","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'redItem'},enchantment_glint_override=true]

execute if score #main lobbyTheme matches 3 run item replace entity @s[tag=!team1] hotbar.3 with minecraft:carrot_on_a_stick[custom_model_data=1033,custom_name='{"text":"Join Saints","color":"red","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'redItem'}]
