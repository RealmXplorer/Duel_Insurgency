...
execute if score #main pylonsDestroyed matches 3 run item replace entity @s inventory.15 with minecraft:cookie[item_model="du-in:lobby/void_cookie",custom_name='{"text":"MY REALITY","color":"light_purple","bold":true,"italic":false}',lore=['{"text":"NOWHERE TO GO BACK TO!","color":"dark_purple"}']]
