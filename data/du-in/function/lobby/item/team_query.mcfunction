...
item replace entity @s[tag=teamMode] hotbar.4 with minecraft:carrot_on_a_stick[item_model="snowball",custom_name='{"text":"Team Query","color":"gray","bold":true,"italic":false}',lore=['{"text":"Right click to see teams!","color":"dark_purple"}'],custom_data={du-in:'queryItem'},consumable={consume_seconds:0,animation:"none",sound:"block.candle.hit",has_consume_particles:false}]
