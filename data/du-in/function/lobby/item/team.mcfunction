...
execute if score #main pylonsDestroyed matches 3.. if entity @s[tag=teamMode] run item replace entity @s hotbar.2 with minecraft:carrot_on_a_stick[item_model="du-in:lobby/void_teamplay",custom_name='{"text":"YOU ARE ALONE","color":"gray","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'teamItem'},consumable={consume_seconds:0,animation:"none",sound:"block.candle.hit",has_consume_particles:false}]

#TEAMPLAY NOT ACTIVE#
execute unless score #main pylonsDestroyed matches 3.. run item replace entity @s[tag=!teamMode] hotbar.2 with minecraft:carrot_on_a_stick[item_model="du-in:lobby/teamgray",custom_name='{"text":"Team Play","color":"red","bold":true,"italic":false}',lore=['{"text":"Right click to use!","color":"dark_purple"}'],custom_data={du-in:'teamItem'},consumable={consume_seconds:0,animation:"none",sound:"block.candle.hit",has_consume_particles:false}]
