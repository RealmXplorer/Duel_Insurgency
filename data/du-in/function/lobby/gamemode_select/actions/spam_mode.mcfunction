...
execute if entity @s[tag=partyLeader,scores={spamMode=1}] run scoreboard players set #spamClick gamemode 1

#execute unless entity @s[tag=partyLeader,scores={spamMode=1}] run tag @a remove spamClick
execute unless entity @s[tag=partyLeader,scores={spamMode=1}] run scoreboard players set #spamClick gamemode 0
...
execute if entity @s[tag=partyLeader,scores={spamMode=1}] run playsound du-in:sfx.unlock master @a ~ ~ ~ .2 1.5
...
execute unless entity @s[tag=partyLeader,scores={spamMode=1}] run playsound du-in:sfx.unlock master @a ~ ~ ~ .2 1.2
