...
execute if entity @s[tag=partyLeader,scores={timedMode=1}] run playsound du-in:sfx.unlock master @a ~ ~ ~ .2 1.5
...
execute unless entity @s[tag=partyLeader,scores={timedMode=1}] run playsound du-in:sfx.unlock master @a ~ ~ ~ .2 1.2
