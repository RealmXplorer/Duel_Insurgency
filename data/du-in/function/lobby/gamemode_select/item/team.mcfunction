...
execute unless score #main pylonsDestroyed matches 3.. if entity @s[tag=teamMode] if score #main lobbyTheme matches 1.. run function du-in:lobby/gamemode_select/item/holiday/holiteam
