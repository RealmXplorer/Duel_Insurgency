...
#San Ricardo
summon minecraft:item 228 92 30 {NoGravity:1b,Age:-32768,Health:99999,PickupDelay:32767,Tags:["mapLabel","displayItem"],Item:{id:"minecraft:sandstone",count:1},CustomNameVisible:1b,CustomName:{text:"San Ricardo",color:"gold",bold:true}}
