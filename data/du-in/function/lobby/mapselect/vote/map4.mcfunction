# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=4}] run function du-in:lobby/mapselect/vote/select
# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=4}] run scoreboard players set @s mapVote 4
execute as @a[distance=..1,tag=!spectating] unless entity @s[scores={mapVote=4}] run function du-in:lobby/mapselect/vote/select
