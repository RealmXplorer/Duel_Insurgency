# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=6}] run function du-in:lobby/mapselect/vote/select
# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=6}] run scoreboard players set @s mapVote 6

execute as @a[distance=..1,tag=!spectating] unless entity @s[scores={mapVote=6}] run function du-in:lobby/mapselect/vote/select
