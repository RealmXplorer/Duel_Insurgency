# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=16}] run function du-in:lobby/mapselect/vote/select
# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=16}] run scoreboard players set @s mapVote 16
execute as @a[distance=..1,tag=!spectating] unless entity @s[scores={mapVote=16}] run function du-in:lobby/mapselect/vote/select
