# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=20}] run function du-in:lobby/mapselect/vote/select
# execute as @a[distance=..1,tag=!spect] unless entity @s[scores={mapVote=20}] run scoreboard players set @s mapVote 20
execute as @a[distance=..1,tag=!spectating] unless entity @s[scores={mapVote=20}] run function du-in:lobby/mapselect/vote/select
