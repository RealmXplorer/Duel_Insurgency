...
summon minecraft:item 228 92 32 {NoGravity:1b,Age:-32768,Health:99999,PickupDelay:32767,Tags:["mapLabel","displayItem"],Item:{id:"minecraft:flowering_azalea_leaves",count:1},CustomNameVisible:1b,CustomName:{text:"Hypostyle",color:"red",bold:true}}
summon marker 230 91 32 {Tags:["mapVote","displayItem","vote4"]} 


summon minecraft:item 228 92 30 {NoGravity:1b,Age:-32768,Health:99999,PickupDelay:32767,Tags:["mapLabel","displayItem"],Item:{id:"minecraft:weathered_copper",count:1},CustomNameVisible:1b,CustomName:{text:"2Fort",color:"blue",bold:true}}
summon marker 230 91 30 {Tags:["mapVote","displayItem","vote3"]} 

summon minecraft:item 228 92 28 {NoGravity:1b,Age:-32768,Health:99999,PickupDelay:32767,Tags:["mapLabel","displayItem"],Item:{id:"minecraft:snow_block",count:1},CustomNameVisible:1b,CustomName:{text:"Clouds",color:"white",bold:true}}
