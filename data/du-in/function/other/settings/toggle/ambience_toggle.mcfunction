...
execute if entity @s[scores={ambienceToggle=1}] run playsound du-in:sfx.unlock master @s ~ ~ ~ .2 1.5
...
execute unless entity @s[scores={ambienceToggle=1}] run playsound du-in:sfx.unlock master @s ~ ~ ~ .2 1.2
