...
#Override tag
execute if entity @a[scores={kit=2015}] run tag @a[tag=!legMusicOff,tag=!void,tag=!ctfIngame,tag=!cqIngame] add musOverride
execute if entity @a[scores={kit=42069}] run tag @a[tag=!legMusicOff,tag=!void,tag=!ctfIngame,tag=!cqIngame] add musOverride
